...
if csvCut == 'CtagT':
  sf = 'emuweight[0]*cTagWeight_CSVT[0]'
...
if useNLO_dy:
    samples['DY'][0] = 'DYJetsToLL_M-50_TuneCUETP8M1_13TeV-amcatnloFXFX-pythia8.root'
